...
public class URL {
    ...
    public static final String GITHUB_VERSION_PATH = "https://cloud.lxweb.cn/f/8xmXF1/version.json";
    public static final String APK_PATH = "https://cloud.lxweb.cn/f/yRV6UE/app-release.apk";
