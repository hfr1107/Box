...
public class URL {
    public static String DOMAIN_NAME_PROXY = "https://";
    public static final String GITHUB_VERSION_PATH = "hfr1107.github.io/up/box/main/version.json";
    public static final String APK_PATH = "cloud.lxweb.cn/f/yRV6UE/app-release.apk";
    ...
    // 默认线路
    public static final String DEFAULT_API_URL = "http://饭太硬.top/tv";
